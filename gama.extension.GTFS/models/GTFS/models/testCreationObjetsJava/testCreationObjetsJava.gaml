...
experiment GTFSExperiment type: gui virtual: true {
    output {
        ...
        monitor "Nombre de bus stops" value: length(bus_stop);
    }
}

// Experiment pour Hanoi
experiment GTFSExperiment_Hanoi type: gui parent: GTFSExperiment {
...
// Experiment pour Nantes
experiment GTFSExperiment_Nantes type: gui parent: GTFSExperiment {
...
experiment GTFSExperiment_Toulouse type: gui parent: GTFSExperiment {
