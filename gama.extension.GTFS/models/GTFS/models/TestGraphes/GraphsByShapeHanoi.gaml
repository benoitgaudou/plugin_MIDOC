/**
 * Name: GraphesParShape_Corrected
 * Description: Test de génération des shapes et graphes avec vérification
...
global {
    ...
    // ✅ CORRECTION 1 : Changer map<int, graph> en map<string, graph>
    // Car shapeId dans TransportShape.java est de type String
    ...
    init {
        ...
        loop s over: transport_shape {
            // ✅ CORRECTION 2 : Utiliser s.shapeId directement (type string)
    ...
    reflex test_graphes when: cycle = 2 {
        ...
        loop sid over: shape_graphs.keys {
            // ✅ CORRECTION 3 : Comparer string avec string (sid est maintenant string)
...
species transport_shape skills: [TransportShapeSkill] {
    // shapeId est déjà défini dans TransportShapeSkill
    // Selon la classe Java, c'est un String
}
